...
* Ecrire une classe Combattant :
  ...
  * Avec les méthodes suivantes :
    ...
    * `subir` prenant en paramètre un nombre de dégât et affectant la vie avec une formule basée sur les dégâts reçus et la défense (degats * (100 - defense) / 100).
...
* Ecrire une classe Arene :
  * Permettant à 2 combattants de rentrer dans l'arene (une méthode entrer).
  * Permettant de dérouler le combat jusqu'à la défaite d'un des combattants :
...
* Faire combattre des combattants.<br/>
Le Chevalier contre le Ninja (et constater la victoire du Chevalier)


---
## Exercice 7.6.d
* Tenter de faire gagner le Ninja sans changer ces caractéristiques :
  * En trichant !
